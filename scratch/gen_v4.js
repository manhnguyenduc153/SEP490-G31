...
async function createExcel() {
    ...
    addCondition('Class exists in DB', ['O', 'O', '', 'O', 'O', '', 'O', 'O', 'O', 'O']);
    addCondition('Class does not exist (ID not found)', ['', '', 'O', '', '', '', '', '', '', '']);
    addCondition('Class ID is <= 0 or missing', ['', '', '', '', '', 'O', '', '', '', '']);
    
    addSubHeader('Teacher Existence');
    addCondition('Teacher exists in DB', ['O', 'O', 'O', '', 'O', 'O', '', 'O', 'O', 'O']);
    addCondition('Teacher does not exist (ID not found)', ['', '', '', 'O', '', '', '', '', '', '']);
    addCondition('Teacher ID is <= 0 or missing', ['', '', '', '', '', '', 'O', '', '', '']);
    
    addSubHeader('Homework Data Status');
    addCondition('All required fields provided and valid', ['O', 'O', 'O', 'O', '', 'O', 'O', '', '', 'O']);
    ...
    addCondition('True (T)', ['O', 'O', '', '', '', '', '', '', '', '']);
    addCondition('False (F)', ['', '', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O']);
    
    addSubHeader('Exception');
    addCondition('Throws Exception', ['', '', '', '', '', '', '', '', '', 'O']);
    
    addSubHeader('Log message');
    addCondition('Thêm bài tập thành công', ['O', 'O', '', '', '', '', '', '', '', '']);
    addCondition('Lỗi validate / DB', ['', '', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O']);
    ...
    const desktopPath = path.join(os.homedir(), 'Desktop', 'CreateHomeworkAsync_TestCase_v4.xlsx');
