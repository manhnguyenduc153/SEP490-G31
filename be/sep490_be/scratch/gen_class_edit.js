...
async function createExcel() {
    ...
    sheet.addRow(['Code Module', 'ClassService', 'Method', 'EditAsync', '','','','','','','','']);
    ...
    addCondition('Class exists in DB (ID valid)', ['O', 'O', '', 'O', 'O', 'O', 'O', 'O', 'O', '']);
    addCondition('Class does not exist (ID not found)', ['', '', 'O', '', '', '', '', '', '', '']);
    
    addSubHeader('Class Basic Info');
    addCondition('Valid update data', ['O', 'O', 'O', '', '', 'O', 'O', 'O', 'O', '']);
    addCondition('Code or Name is missing/empty/invalid', ['', '', '', 'O', '', '', '', '', '', '']);
    addCondition('Code or Name exists in another class', ['', '', '', '', 'O', '', '', '', '', '']);
    
    addSubHeader('References (Course, Teacher, Students)');
    addCondition('All foreign keys valid', ['O', 'O', '', '', '', '', '', 'O', 'O', '']);
    addCondition('CourseId or TeacherId not found', ['', '', '', '', '', 'O', '', '', '', '']);
    addCondition('StudentIds contain invalid ID', ['', '', '', '', '', '', 'O', '', '', '']);
    
    addSubHeader('Schedule & Capacity');
    addCondition('Valid schedule and capacity', ['O', 'O', '', '', '', '', '', '', '', '']);
    ...
    addCondition('UPDATE_CLASS_SUCCESS', ['O', 'O', '', '', '', '', '', '', '', '']);
    addCondition('ERR_CLASS_NOT_FOUND', ['', '', 'O', '', '', '', '', '', '', '']);
    addCondition('ERR_DUPLICATE / ERR_EMPTY / ERR_MAX', ['', '', '', 'O', 'O', '', '', '', '', '']);
    ...
    const desktopPath = path.join(os.homedir(), 'Desktop', 'EditClassAsync_TestCase.xlsx');
