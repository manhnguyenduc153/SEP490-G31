...
namespace sep490_be.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<IActionResult> Delete(string id)
        {
            ...
            if (currentUserId == id)
            {
                return StatusCode(Microsoft.AspNetCore.Http.StatusCodes.Status400BadRequest, 
                    sep490_be.DTO.ApiResponse<bool>.Fail("ERR_CANNOT_DELETE_SELF", Microsoft.AspNetCore.Http.StatusCodes.Status400BadRequest));
            }
        ...
        public async Task<IActionResult> Deactive(string id)
        {
            ...
            {
                return StatusCode(Microsoft.AspNetCore.Http.StatusCodes.Status400BadRequest, 
                    sep490_be.DTO.ApiResponse<bool>.Fail("ERR_CANNOT_DEACTIVATE_SELF", Microsoft.AspNetCore.Http.StatusCodes.Status400BadRequest));
            }
